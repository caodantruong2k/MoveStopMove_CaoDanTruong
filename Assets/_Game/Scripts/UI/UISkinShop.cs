...
{
    public enum ShopSkinType { Hat, Pant, Accessory, Skin, Weapon }

    [SerializeField] SkinShopData data;
    ...
    [SerializeField] TextMeshProUGUI adsTxt;

    [SerializeField] MiniPool<ShopItem> miniPool = new MiniPool<ShopItem>();
    ...
    public ShopSkinType skinType => currentBar.Type;
    ...
    public override void Open()
    {
        ...
        CameraFollower.Ins.ChangeState(CameraFollower.CameraState.Shop);
    ...
    //public string GetDataKeys(SkinType SkinType)
    //{
    //    switch (SkinType)
    //    {
    //        case SkinType.Hat: return UserData.Keys_Hat_Data;
    //        case SkinType.Pant: return UserData.Keys_Pant_Data;
    //        case SkinType.Accessory: return UserData.Keys_Accessory_Data;
    //        case SkinType.Skin: return UserData.Keys_Skin_Data;
    //        case SkinType.Weapon: return UserData.Keys_Weapon_Data;
    //        default: return string.Empty;
    //    }
    //}  

    //public List<ShopItemData<T>> GetListItems<T>(SkinType SkinType) where T : Enum
    //{
    //    switch (SkinType)
    //    {
    //        case SkinType.Hat: return data.hats.Ts as List<ShopItemData<T>>;
    //        case SkinType.Pant: return data.pants.Ts as List<ShopItemData<T>>;
    //        case SkinType.Accessory: return data.accessories.Ts as List<ShopItemData<T>>;
    //        case SkinType.Skin: return data.skins.Ts as List<ShopItemData<T>>;
    //        case SkinType.Weapon: return null;
    //        default: return null;
    //    }
    //}
    ...
    internal void SelectItem(ShopItem item)
    {
        ...
        switch (currentItem.state)
        {
            ...
            case ShopItem.State.Bought:
                buttonState.SetState(ButtonState.State.Select);
                break;
        ...
        LevelManager.Ins.player.TryCloth(skinType, currentItem.Type);
